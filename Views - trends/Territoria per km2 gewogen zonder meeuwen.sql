/* UITLEG
Deze query is bedoeld voor een view/rapport: Territoria per km2 gewogen zonder meeuwen.
*/
...
TotaalOppervlaktePerJaar AS (
    ...
    AND EXISTS (SELECT 1 FROM territoria w WHERE w.jaar = plot_jaar_oppervlak.jaar)
    GROUP BY jaar
)
