...
- ruwe FFV-bronnen: `/Volumes/T7 Data/Home_Ton/Meijendel data/NDFF/open_ffv/raw`
- GeoPackage: `/Volumes/T7 Data/Home_Ton/Meijendel data/NDFF/open_ffv/staging/ndff_meijendel_staging_1950_2025.gpkg`
- manifest en bouwrapport: dezelfde map met extensie `.json`
...
PYTHONDONTWRITEBYTECODE=1 python3 gis/scripts/build_ndff_staging.py \
  --source-dir '/Volumes/T7 Data/Home_Ton/Meijendel data/NDFF/open_ffv/raw' \
  --output '/Volumes/T7 Data/Home_Ton/Meijendel data/NDFF/open_ffv/staging/ndff_meijendel_staging_1950_2025.gpkg' \
  --replace
```
