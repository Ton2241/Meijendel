...
const positions = {
  ...
  txtDetail: [15, 18, 43, 49],
  txtDetailMetaValues: [15, 18, 49, 60],
  txtDetailContactTitel: [20, 23, 43, 60],
  txtDetailContactLabels: [24, 29, 43, 49],
  txtDetailContactValues: [24, 29, 49, 60],
  txtDetailTellingTitel: [31, 34, 43, 60],
  txtDetailTellingLabels: [35, 41, 43, 50],
  txtDetailTellingValues: [35, 41, 50, 60],
  txtDetailStatusLabel: [43, 46, 43, 50],
  txtDetailStatusValue: [43, 46, 50, 60],
};
...
appsmithDb.codexPageBackups.insertOne({
  pageId,
  createdAt: now,
  reason: "Voor verder verkleinen witruimte detailvlak lid",
  page,
});
