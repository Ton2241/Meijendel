...
const positions = {
  ...
  txtDetail: [14, 20, 43, 49],
  txtDetailMetaValues: [14, 20, 49, 60],
  txtDetailContactTitel: [21, 23, 43, 60],
  txtDetailContactLabels: [23, 31, 43, 49],
  txtDetailContactValues: [23, 31, 49, 60],
  txtDetailTellingTitel: [32, 34, 43, 60],
  txtDetailTellingLabels: [34, 44, 43, 50],
  txtDetailTellingValues: [34, 44, 50, 60],
  txtDetailStatusLabel: [45, 50, 43, 50],
  txtDetailStatusValue: [45, 50, 50, 60],
};
...
appsmithDb.codexPageBackups.insertOne({
  pageId,
  createdAt: now,
  reason: "Voor verkleinen afstand tussen detailkoppen en tekstblokken",
  page,
});
...
printjson(Object.fromEntries(Object.keys(positions).map((name) => {
  ...
  return [name, [widget.topRow, widget.bottomRow]];
})));
