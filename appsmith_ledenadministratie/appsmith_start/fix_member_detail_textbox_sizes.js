...
const positions = {
  ...
  txtDetail: [15, 21, 43, 49],
  txtDetailMetaValues: [15, 21, 49, 60],
  txtDetailContactTitel: [22, 25, 43, 60],
  txtDetailContactLabels: [26, 34, 43, 49],
  txtDetailContactValues: [26, 34, 49, 60],
  txtDetailTellingTitel: [35, 38, 43, 60],
  txtDetailTellingLabels: [39, 49, 43, 50],
  txtDetailTellingValues: [39, 49, 50, 60],
  txtDetailStatusLabel: [51, 56, 43, 50],
  txtDetailStatusValue: [51, 56, 50, 60],
};
...
appsmithDb.codexPageBackups.insertOne({
  pageId,
  createdAt: now,
  reason: "Voor herstellen tekstboxhoogtes detailvlak lid",
  page,
});
