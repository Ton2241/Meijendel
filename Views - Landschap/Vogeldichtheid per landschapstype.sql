/* UITLEG
Deze query is bedoeld voor een view/rapport: Vogeldichtheid per landschapstype.
*/
...
actieve_oppervlakte AS (
  ...
  -- Alleen voor jaren waarin daadwerkelijk territoria zijn geregistreerd
  SELECT 
    w.jaar,
...
data_bron AS (
  ...
  INNER JOIN territoria w ON lv.soort_id = w.soort_id
  INNER JOIN geselecteerde_plots gp ON w.plot_id = gp.plot_id
