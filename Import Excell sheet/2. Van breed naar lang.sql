/* UITLEG
Dit bestand hoort bij het importproces: 2. Van breed naar lang.
*/

-- Stap 1: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 2: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 3: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 4: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 5: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 6: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 7: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 8: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 10: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 11: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 12: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 13: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 15: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 16: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 17: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 18: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 19: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 20: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 21: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 22: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 23: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 24: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 25: Uitvoering van een SQL‑statement.
...
-- Stap 26: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 27: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 28: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 29: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 30: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 31: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 32: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 33: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 34: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 35: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 36: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 37: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 38: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 39: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 40: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 41: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 42: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 43: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 44: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 45: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 46: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 47: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 48: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 49: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 50: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 51: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 52: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 53: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
...
-- Stap 54: Voegt rijen toe aan tabel `import_waarnemingen_lang`.
